...
const SENDER_CONFIG: Record<SenderType, {
  ...
  human_talent: {
    ...
    bg: 'bg-amber-500/10',
    bubbleBg: 'border border-border/50 bg-card',
  },
};
...
const MOCK_CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      {
        id: 'm1', senderType: 'ai_hr', senderName: 'AI HR',
        content: '你好张伟，我是贵司的 AI HR。我们注意到您在分布式系统方面有丰富的经验，目前有一个高级后端工程师的机会想和您聊聊。这个角色主要负责微服务架构的设计与优化，您之前在这方面有哪些实践经验呢？',
        createdAt: '2026-03-31T09:00:00Z',
      },
      {
        id: 'm2', senderType: 'ai_talent', senderName: '张伟',
        content: '你好！我在之前的公司负责过一套 Go 微服务架构的从零搭建，日均处理请求量在 500 万左右。我对高并发场景下的服务治理比较有经验，包括限流、熔断和链路追踪。',
        createdAt: '2026-03-31T09:05:00Z',
      },
      {
        id: 'm3', senderType: 'ai_hr', senderName: 'AI HR',
        content: '非常棒的经验！你们当时的技术栈是怎样的？我们这边主要用 Go + gRPC + Kubernetes，想看看是否匹配。',
        createdAt: '2026-03-31T09:08:00Z',
      },
      {
        id: 'm4', senderType: 'ai_talent', senderName: '张伟',
        content: '技术栈很接近。我们用的是 Go + gRPC，容器编排用的 K8s，消息队列用 Kafka。监控方面用 Prometheus + Grafana。基本上是业界比较主流的方案。',
        createdAt: '2026-03-31T09:15:00Z',
      },
      {
        id: 'm5', senderType: 'ai_hr', senderName: 'AI HR',
        content: '技术栈高度匹配。另外想了解一下，您对工作模式有什么偏好？我们支持远程和混合办公。',
        createdAt: '2026-03-31T09:20:00Z',
      },
      {
        id: 'm6', senderType: 'ai_talent', senderName: '张伟',
        content: '我目前在杭州，远程办公对我来说非常理想。我之前远程工作过一年多，效率和协作都没有问题。',
        createdAt: '2026-03-31T09:25:00Z',
      },
      {
        id: 'm7', senderType: 'human_enterprise', senderName: '招聘负责人',
        content: '张伟你好，我是技术团队的负责人。看了 AI 的沟通记录，你的背景确实很匹配我们的需求。想问一下你对薪资有什么预期？',
        createdAt: '2026-03-31T14:00:00Z',
      },
      {
        id: 'm8', senderType: 'human_talent', senderName: '张伟',
        content: '好的，我对远程工作模式很感兴趣，可以进一步聊聊。薪资方面我的预期是年薪 50-65 万，可以根据具体情况协商。',
        createdAt: '2026-03-31T14:32:00Z',
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: 'm10', senderType: 'ai_hr', senderName: 'AI HR',
        content: '你好李明，我们正在寻找一位高级后端工程师。看到你在云原生和 DevOps 方面的经验，想和你聊聊这个机会。',
        createdAt: '2026-03-30T10:00:00Z',
      },
      {
        id: 'm11', senderType: 'ai_talent', senderName: '李明',
        content: '你好，感谢联系。我目前确实在看新的机会。能介绍一下具体的团队和项目方向吗？',
        createdAt: '2026-03-30T10:10:00Z',
      },
      {
        id: 'm12', senderType: 'ai_hr', senderName: 'AI HR',
        content: '当然。这是一个做 AI 基础设施的团队，主要负责模型推理平台和数据管道。技术栈以 Go 和 Python 为主，部署在 K8s 上。团队目前 8 人，产品已有企业客户在使用。',
        createdAt: '2026-03-30T10:15:00Z',
      },
      {
        id: 'm13', senderType: 'ai_talent', senderName: '李明',
        content: 'AI 基础设施方向很有意思。我之前在蚂蚁做过类似的推理服务优化，对 GPU 调度和模型部署有一些经验。这个方向我很感兴趣。',
        createdAt: '2026-03-30T10:25:00Z',
      },
      {
        id: 'm14', senderType: 'ai_hr', senderName: 'AI HR',
        content: '太好了，你的背景和我们的需求非常匹配。AI 预沟通已完成，候选人对项目方向很感兴趣。建议企业方安排进一步面试。',
  ...
  },
  {
    ...
    messages: [
      {
        id: 'm20', senderType: 'ai_hr', senderName: 'AI HR',
        content: '陈强你好，我们有一个 LLM 应用架构师的机会，需要有 RAG 架构落地经验的人才。看到您的背景非常匹配。',
        createdAt: '2026-03-30T14:00:00Z',
      },
      {
        id: 'm21', senderType: 'ai_talent', senderName: '陈强',
        content: '你好！RAG 是我目前主要的技术方向。我在 RAG + Agent 方面有 3 个生产级项目的经验，包括企业知识库、智能客服和代码生成助手。',
        createdAt: '2026-03-30T14:10:00Z',
      },
      {
        id: 'm22', senderType: 'ai_hr', senderName: 'AI HR',
        content: '这些经验非常宝贵。能详细说一下在企业知识库项目中你是如何处理多模态文档检索的吗？',
        createdAt: '2026-03-30T14:15:00Z',
      },
      {
        id: 'm23', senderType: 'ai_talent', senderName: '陈强',
        content: '我们采用了混合检索方案：dense embedding（BGE-M3）+ sparse（BM25），配合 reranker。对于多模态内容，图表走 OCR + 描述生成后入索引，PDF 走分块 + metadata 增强。整体召回率从 65% 提升到 89%。',
  ...
  },
  {
    ...
    messages: [
      {
        id: 'm30', senderType: 'ai_hr', senderName: 'AI HR',
        content: '你好王芳，我们有一个高级后端工程师的机会，主要做微服务平台化。看到你在后端开发方面有不错的经验，想进一步了解一下。',
        createdAt: '2026-04-01T08:00:00Z',
      },
      {
        id: 'm31', senderType: 'ai_talent', senderName: '王芳',
        content: '你好，谢谢联系。我目前在一家中型公司做 Java 后端，正在考虑转型到 Go 技术栈。能介绍一下你们的技术栈和团队规模吗？',
  ...
  },
  {
    ...
    messages: [
      {
        id: 'm40', senderType: 'ai_hr', senderName: 'AI HR',
        content: '赵慧你好，我们有一个 LLM 应用架构师的机会，需要有实际产品落地经验。看到你在 NLP 方面的研究背景，想了解一下。',
        createdAt: '2026-03-29T09:00:00Z',
      },
      {
        id: 'm41', senderType: 'ai_talent', senderName: '赵慧',
        content: '你好。我的背景主要是学术研究方向，在 ACL、EMNLP 发过几篇论文。工程落地经验相对少一些，更擅长模型训练和评估。',
        createdAt: '2026-03-29T09:20:00Z',
      },
      {
        id: 'm42', senderType: 'ai_hr', senderName: 'AI HR',
        content: '感谢你的坦诚。我们这个角色更偏向工程和产品化，需要有生产级系统的架构经验。你的研究背景非常出色，但可能和当前需求有些差距。如果后续有更偏研究方向的机会，我们会第一时间联系你。',
        ...
        <ScrollArea className="flex-1">
          <div className="divide-y divide-border/20">
            {filteredConversations.map((conv) => {
              ...
              const statusCfg = STATUS_LABEL[conv.status];
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5">
                        <span className="text-sm font-medium text-foreground">{conv.talentName}</span>
                        {conv.unread && (
                          ...
                          <div className={cn('flex items-center gap-1.5', right ? 'flex-row-reverse' : 'flex-row')}>
                            ...
                            {ai && (
                              <Badge
                                variant="outline"
                                className={cn(
                                  'h-4 border-current px-1 text-[9px] font-normal leading-none',
                                  config.color
                                )}
                              >
                                AI
